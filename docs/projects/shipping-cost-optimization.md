...
No? Well, me neither. Let's investigate how its done anyways!
Stay with me, its worth it: we will reduce shipping cost by 55% just by intelligently exploiting the degressive cost-per-weight structure in today's CEP sector and reduce our cost to serve by up to 20%.
We will rediscover the knapsack problem along the way and prove optimal bin allocation alone yields lower-than-industry cost to serve.
Enough for the hook. Let's do it!
{: .fs-6 .fw-300 }
...
The case study showed combined warehouse and carrier costs of about 20% for small and as low as 10% for large subscriptions, excluding return shipments.
In comparison to industry standards The Oater is operating at the lower end through optimized goods allocation  (see [The geography of transport systems](https://transportgeography.org/contents/chapter7/logistics-freight-distribution/ecommerce-cost-structure/?utm_source=chatgpt.com), [Amazon's logistics costs](https://www.statista.com/chart/17207/amazon-shipping-and-fulfillment-costs/), [Business insider](https://www.businessinsider.com/amazon-earnings-call-report-amzn-stock-live-updates-2025-2)).
